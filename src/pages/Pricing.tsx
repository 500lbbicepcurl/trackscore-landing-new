      ...
      <main className="flex-grow pt-16">
        ...
        <section className="py-20 px-6 lg:px-8">
          <div className="container mx-auto max-w-7xl">
            ...
            >
              <h1 className="text-5xl md:text-6xl font-bold text-[#1d1e20] mb-4" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
              ...
              {plans.map((plan, index) => (
                <motion.div
                  ...
                  className={`bg-white rounded-2xl shadow-lg border-2 p-8 relative ${
                    plan.isPopular ? "border-blue-600 shadow-xl scale-105" : "border-gray-200"
                  }`}
                >
                  {plan.isPopular && (
                  ...
                  <button
                    className={`w-full py-3 px-6 rounded-xl font-medium transition-colors mb-6 ${plan.buttonStyle}`}
                  >
                    {plan.buttonText}
                  </button>
        ...
        <section className="py-20 px-6 lg:px-8 bg-gray-50">
          <div className="container mx-auto max-w-7xl">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-[#1d1e20] mb-4" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
