...
const ScalysisVsOther = () => {
  ...
  const comparisonData = [{
    feature: "Base Cost",
    scalysis: "₹4.50-₹5.50/minute (Volume-based pricing)",
    ...
    scalysis: "Per-minute pricing (₹4.50-₹5.50/minute (all inclusive))",
...
export default ScalysisVsOther;
