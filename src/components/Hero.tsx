...
const Hero = () => {
  ...
  return <section ref={sectionRef} className="relative min-h-screen bg-white overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-6 lg:px-8 pt-24 pb-4 relative z-10">
        <div className="flex flex-col items-center text-center max-w-6xl mx-auto">
          ...
          <motion.a href="https://scalysis.com/login" target="_blank" rel="noopener noreferrer" initial={{
          opacity: 0,
          y: 20
        }} animate={{
          opacity: 1,
          ...
          duration: 0.6,
          delay: 0.1
        }} className="text-[60px] md:text-[80px] lg:text-[90px] font-medium leading-[88.32px] tracking-[-3.6px] text-[#1d1e20] mb-6 max-w-5xl" style={{
          ...
          duration: 0.6,
          delay: 0.2
        }} className="text-[22px] font-medium leading-[30.8px] tracking-[-0.3px] text-[#31373d] mb-12" style={{
          ...
          delay: 0.3
            ...
            <a href="https://wa.me/919149874123" target="_blank" rel="noopener noreferrer" className="bg-[#1d1e20] border border-[#505967] rounded-[12px] px-[16px] py-[13px] inline-block">
          ...
          duration: 0.6,
          delay: 0.4
        }} className="relative flex items-center justify-center gap-2 text-[#5066d3] text-[16px] font-normal italic mt-2 mb-12" style={{
        ...
        <div className="relative w-full max-w-6xl mx-auto px-6">
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            ...
            <div className="relative w-full h-[500px] md:h-[600px] bg-gradient-to-br from-[#1c1833] via-[#262044] to-[#1c192c]">
              {/* Autoplay Video */}
              <video src="/hero-video-trim.mp4" autoPlay loop muted playsInline className="absolute inset-0 w-full h-full object-cover" />
