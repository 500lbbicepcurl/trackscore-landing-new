...
const Features = () => {
  ...
  return (
    <section id="features" className="py-20 bg-gradient-secondary relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="space-y-6">
            <p className="inline-block text-sm font-medium px-3 py-1 bg-white/20 text-white rounded-full mb-4 border border-white/30">
              Powerful Features
            </p>
