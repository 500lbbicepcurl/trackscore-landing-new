...
const ScaleWithSecurity = () => {
  return (
    <section className="relative bg-white py-[160px] min-h-[422px] overflow-hidden">
        ...
        <div className="max-w-[1440px] mx-auto">
          ...
          <div className="flex items-center justify-between gap-12">
            ...
            >
              {/* Heading */}
              <h2 
                className="text-[38px] font-bold leading-[44px] tracking-[-0.8px] text-[#1d1e20] mb-6"
            ...
            >
              ...
              <div className="flex flex-col gap-8">
                <div className="h-[52px] w-[121.97px]">
                  <img 
                    src={imgGdprReadyBadgeXel6QvfiWebp} 
                    alt="GDPR Ready" 
                ...
                <div className="h-[52px] w-[121.97px]">
                  <img 
                    src={imgCcpaReadyBadgeIt2PevyyWebp} 
                    alt="CCPA Ready" 
                    className="w-full h-full object-contain" 
                  />
                </div>
              ...
              <div className="flex flex-col gap-8">
                <div className="h-[92px] w-[79px]">
                  <img 
                    src={imgIso9001BadgeYsygvgzjWebp} 
                    alt="ISO 9001" 
                    className="w-full h-full object-contain" 
                  />
                </div>
                <div className="h-[92px] w-[92px]">
                  <img 
                    src={imgIso27001Badge3Hcqbte2Webp} 
                    alt="ISO 27001" 
                    className="w-full h-full object-contain" 
                  />
                </div>
